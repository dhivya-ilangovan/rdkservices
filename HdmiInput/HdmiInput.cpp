...
namespace WPEFramework
{
    namespace Plugin
    {
		...
		IARM_CHECK( IARM_Bus_RegisterEventHandler(IARM_BUS_DSMGR_NAME,IARM_BUS_DSMGR_EVENT_HDMI_IN_ALLM_STATUS, dsHdmiGameStatusEventHandler) );
            }
        }
        ...
        void HdmiInput::dsHdmiiGameFeatureStatusEventHandler(const char *owner, IARM_EventId_t eventId, void *data, size_t len)
        {
            if(!HdmiInput::_instance)
                return;
